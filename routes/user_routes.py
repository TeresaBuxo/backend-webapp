...
user_route = APIRouter(prefix="/api")
...
@user_route.post("/users/",response_model=schema.User,tags = ['users'])
...
@user_route.delete("/users/{user_id}",tags = ['users'])
...
@user_route.post("/users/token",tags = ['users'])#, response_model=schema.Token)
...
@user_route.get("/users/me",tags = ['users'])
